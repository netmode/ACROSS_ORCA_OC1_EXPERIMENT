...
# Title: udp_receive.py
# Authors: G. Kakkavas, K. Tsitseklis
# Generated: Tue Sep 18 10:08:16 2018
##################################################
...
class udp_receive(gr.top_block):
    ...
    def __init__(self, IP_address, udp_port, filename):
        ...
        # Blocks
        ##################################################
        self.blocks_udp_source_0 = blocks.udp_source(gr.sizeof_gr_complex*1, IP_address, udp_port, 1472, True)
...
def receive(IP_address, udp_port, filename, top_block_cls=udp_receive, options=None):
    """ Receives data via udp
        IP_address: your own IP address
        udp_port: the port utilized
        filename: file where the received data will be stored """
